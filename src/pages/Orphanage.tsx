...
import {
  ...
  StyleSheet, Dimensions, TouchableOpacity, Linking,
} from 'react-native';
...
export default function Orphanage() {
  ...
  function handleNavigationToGoogleMaps() {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={handleNavigationToGoogleMaps}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>{orphanage.openingHours}</Text>
          </View>
